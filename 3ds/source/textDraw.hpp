...
void drawButton (button* buttonToDraw, u32 color, double weight) {
	C2D_DrawLine(buttonToDraw->x, buttonToDraw->y, color, buttonToDraw->x + buttonToDraw->w, buttonToDraw->y, color, weight, 0.99);
	C2D_DrawLine(buttonToDraw->x, buttonToDraw->y, color, buttonToDraw->x, buttonToDraw->y + buttonToDraw->h, color, weight, 0.99);
	C2D_DrawLine(buttonToDraw->x, buttonToDraw->y + buttonToDraw->h, color, buttonToDraw->x + buttonToDraw->w, buttonToDraw->y + buttonToDraw->h, color, weight, 0.99);
	C2D_DrawLine(buttonToDraw->x + buttonToDraw->w, buttonToDraw->y, color, buttonToDraw->x + buttonToDraw->w, buttonToDraw->y + buttonToDraw->h, color, weight, 0.99);
	C2D_DrawCircleSolid(buttonToDraw->x, buttonToDraw->y, 0.99, weight/2, color);
	C2D_DrawCircleSolid(buttonToDraw->x + buttonToDraw->w, buttonToDraw->y, 0.99, weight/2, color);
	C2D_DrawCircleSolid(buttonToDraw->x, buttonToDraw->y + buttonToDraw->h, 0.99, weight/2, color);
	C2D_DrawCircleSolid(buttonToDraw->x + buttonToDraw->w, buttonToDraw->y + buttonToDraw->h, 0.99, weight/2, color);
