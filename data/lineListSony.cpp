...
line* linelistBG[] = {
	new line(100 - 10/8.0f, 45 - 10/8.0f, 80 + 10/8.0f, 25 + 10/8.0f), // Level 1, X Button
	new line(80 + 10/8.0f, 45 - 10/8.0f, 100 - 10/8.0f, 25 + 10/8.0f), // Level 1, X Button
	new line(-1, -1, -1, -1), // Level 1, Offscreen Line
	new line(90, 10, 65, 35), // Level 1, X Button
	new line(90, 10, 115, 35), // Level 1, X Button
	new line(90, 60, 65, 35), // Level 1, X Button
	new line(90, 60, 115, 35), // Level 1, X Button
